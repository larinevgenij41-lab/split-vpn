...
#>
param(
    # По умолчанию — самый свежий собранный установщик: путь с номером версии быстро устаревал.
    [string]$Msi = (Get-ChildItem (Join-Path (Split-Path -Parent $PSScriptRoot) 'artifacts\installer\*.msi') |
