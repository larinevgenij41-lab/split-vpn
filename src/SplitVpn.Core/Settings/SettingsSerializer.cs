...
public static class SettingsSerializer
{
    ...
    public static AppSettings Normalize(AppSettings? settings)
    {
        ...
        return model with
        {
            ...
            AppUpdate = NormalizeAppUpdate(model.AppUpdate),
    ...
    private static AppUpdateSettings NormalizeAppUpdate(AppUpdateSettings? update)
    {
        var model = update ?? new AppUpdateSettings();
        return model with { ManifestMirrors = Texts(model.ManifestMirrors), PackageMirrors = Texts(model.PackageMirrors) };
    }
