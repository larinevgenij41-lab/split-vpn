...
public sealed record WfpFilterInfo(ulong Id, string Name, byte Weight, bool Persistent, Guid Layer);
...
public static unsafe class WfpOps
{
    ...
    private static FWPM_FILTER_CONDITION0 BuildCondition(FilterCondition condition, NativeArena arena, ConditionCache cache) => condition switch
    {
        ...
        RemotePortCondition p => Uint16(PInvoke.FWPM_CONDITION_IP_REMOTE_PORT, p.Port, p.NotEqual),
    ...
    private static FWPM_FILTER_CONDITION0 Uint16(Guid field, ushort value, bool notEqual = false)
    {
        var condition = new FWPM_FILTER_CONDITION0 { fieldKey = field, matchType = notEqual ? FWP_MATCH_TYPE.FWP_MATCH_NOT_EQUAL : FWP_MATCH_TYPE.FWP_MATCH_EQUAL };
    ...
    private static readonly Guid[] LayersV4 = [PInvoke.FWPM_LAYER_ALE_AUTH_CONNECT_V4, PInvoke.FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V4];
    private static readonly Guid[] LayersV6 = [PInvoke.FWPM_LAYER_ALE_AUTH_CONNECT_V6, PInvoke.FWPM_LAYER_ALE_AUTH_RECV_ACCEPT_V6];
    private static readonly Guid[] LayersBoth = [.. LayersV4, .. LayersV6];

    internal static IReadOnlyList<Guid> LayersOf(FilterFamily family) => family switch
    {
        FilterFamily.V4 => LayersV4,
        FilterFamily.V6 => LayersV6,
        FilterFamily.Both => LayersBoth,
