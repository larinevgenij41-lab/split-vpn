...
/// <summary>Перенос элементов строки при недостатке места.</summary>
public sealed class WidthBelowConverter : IValueConverter
{
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        value is double width && double.TryParse(parameter as string, NumberStyles.Float, CultureInfo.InvariantCulture, out var breakpoint)
        && width < breakpoint;
